...
<template>
  <div class="document">
    ...
    <p>Stand: 15.05.2018, in Bearbeitung</p>
    ...
    <p>Außer bei den oben genannten Anwendungen erfolgt keine Übermittlung in Staaten außerhalb der EU und ist auch nicht geplant.</p>
    <h2>Betroffenenrechte</h2>
    <p>Sie haben das Recht auf:</p>
    <ul>
      <li>Auskunft über Ihre gespeicherten Daten</li>
      <li>Berichtigung und Vervollständigung Ihrer hinterlegten Daten</li>
      <li>Löschung Ihrer nicht mehr benötigten Daten</li>
      <li>Einschränkung der Verarbeitung Ihrer Daten</li>
      <li>Widerruf erteilter Einwilligungen mit Wirkung für die Zukunft</li>
      <li>Widerspruch bezüglich der künftigen Verarbeitung der Sie betreffenden Daten, insbesondere gegen die Verarbeitung für Zwecke der Direktwerbung</li>
      <li>Erhalt und Übermittlung an andere Verantwortliche der Sie betreffenden Daten</li>
    </ul>
    <h2>Erbringung vertraglicher Leistungen</h2>
    <p>Sofern Bestandsdaten (z.B., Namen und Adressen sowie Kontaktdaten von Nutzern) verarbeitet werden, geschieht dies zur Erfüllung unserer vertraglichen Verpflichtungen und Serviceleistungen gem. Art. 6 Abs. 1 lit b. DSGVO. So sind die in Onlineformularen als verpflichtend gekennzeichneten Eingaben für den Vertragsschluss erforderlich.</p>
    ...
    <p>Die Angaben der Nutzer können in einem Customer-Relationship-Management System ("CRM System") oder vergleichbarer Anfragenorganisation gespeichert werden.</p>
    ...
    <p>Wir betreiben im Rahmen unserer berechtigten Interessen im Sinne des Art. 6 Abs. 1 lit. f. DSGVO Onlinepräsenzen innerhalb sozialer Netzwerke und Plattformen, um mit den dort aktiven Kunden, Interessenten und Nutzern zu kommunizieren und sie dort über unsere Leistungen informieren zu können. Beim Aufruf der jeweiligen Netzwerke und Plattformen gelten die Geschäftsbedingungen und die Datenverarbeitungsrichtlinien deren jeweiligen Betreiber.</p>
    ...
    <ul>
      <li>Externe Schriftarten von Google, LLC., <LinkExternal href="https://fonts.google.com">https://fonts.google.com</LinkExternal> („Google Fonts“). Die Einbindung der Google Fonts erfolgt durch einen Serveraufruf bei Google (in der Regel in den USA). Datenschutzerklärung: <LinkExternal href="https://policies.google.com/privacy">https://policies.google.com/privacy</LinkExternal>, Opt-Out: <LinkExternal href="https://adssettings.google.com">https://adssettings.google.com</LinkExternal>.</li>
      <li>Landkarten des Dienstes „Google Maps“ des Drittanbieters Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA, gestellt. Datenschutzerklärung: <LinkExternal href="https://policies.google.com/privacy">https://policies.google.com/privacy</LinkExternal>, Opt-Out: <LinkExternal href="https://adssettings.google.com">https://adssettings.google.com</LinkExternal>.</li>
      <li>Videos der Plattform “YouTube” des Drittanbieters Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA. Datenschutzerklärung: <LinkExternal href="">https://policies.google.com/privacy</LinkExternal>, Opt-Out: <LinkExternal href="https://adssettings.google.com">https://adssettings.google.com</LinkExternal>.</li>
      <li>Innerhalb unseres Onlineangebotes können Funktionen des Dienstes, bzw. der Plattform Twitter eingebunden sein (nachfolgend bezeichnet als „Twitter“). Twitter ist ein Angebot der Twitter Inc., 1355 Market Street, Suite 900, San Francisco, CA 94103, USA. Die Funktionen beinhalten die Darstellung unserer Beiträge innerhalb von Twitter innerhalb unseres Onlineangebotes, die Verknüpfung zu unserem Profil bei Twitter sowie die Möglichkeit mit den Beiträgen und den Funktionen von Twitter zu interagieren, als auch zu messen, ob Nutzer über die von uns bei Twitter geschalteten Werbeanzeigen auf unser <LinkExternal href="https://foe-fa.de">Onlineangebot</LinkExternal> gelangen (sog. Conversion-Messung). Twitter ist unter dem Privacy-Shield-Abkommen zertifiziert und bietet hierdurch eine Garantie, das europäische Datenschutzrecht einzuhalten (<LinkExternal href="https://www.privacyshield.gov/participant?id=a2zt0000000TORzAAO">https://www.privacyshield.gov/participant?id=a2zt0000000TORzAAO</LinkExternal>). Datenschutzerklärung: <LinkExternal href="https://twitter.com/de/privacy">https://twitter.com/de/privacy</LinkExternal>, Opt-Out: <LinkExternal href="https://twitter.com/personalization">https://twitter.com/personalization</LinkExternal>.</li>
      <li>
        ...
        <br />Die Datenschutzerklärung für Vimeo mit näheren Informationen zur Erhebung und Nutzung Ihrer Daten durch Vimeo finden Sie unter <LinkExternal href="https://vimeo.com/privacy">https://vimeo.com/privacy</LinkExternal>.
        ...
        >https://tools.google.com/dlpage/gaoptout</LinkExternal>
      </li>
      <li>
        Externer Code des JavaScript-Frameworks “jQuery”, bereitgestellt durch den Dritt-Anbieter jQuery Foundation,
        <LinkExternal href="https://jquery.org">https://jquery.org</LinkExternal>.
      </li>
    </ul>
    <h2>Aufsichtsbehörde</h2>
    <p>Gemäß Artikel 77 EU-DSGVO können Sie Beschwerde bei einer Aufsichtsbehörde erheben, wenn Sie der Ansicht sind, dass die Verarbeitung der sie betreffenden personenbezogenen Daten gegen die EU-DSGVO oder das BDSG verstößt.</p>
    <h2>Newsletter</h2>
    ...
    <p>Versanddienstleister: Der Versand der Newsletter erfolgt mittels „MailChimp“, einer Newsletterversandplattform des US-Anbieters Rocket Science Group, LLC, 675 Ponce De Leon Ave NE #5000, Atlanta, GA 30308, USA. Die Datenschutzbestimmungen des Versanddienstleisters können Sie hier einsehen: <LinkExternal href="">mailchimp.com/legal/privacy/.</LinkExternal></p>
    <p>The Rocket Science Group LLC d/b/a MailChimp ist unter dem Privacy-Shield-Abkommen zertifiziert und bietet hierdurch eine Garantie, das europäisches Datenschutzniveau einzuhalten (<LinkExternal href="https://www.privacyshield.gov/participant?id=a2zt0000000TO6hAAG">https://www.privacyshield.gov/participant?id=a2zt0000000TO6hAAG</LinkExternal>)</p>
    ...
    <p>Sie können dem Einsatz von Cookies, die der Reichweitenmessung und Werbezwecken dienen, über die Deaktivierungsseite der Netzwerkwerbeinitiative (<LinkExternal href="">http://optout.networkadvertising.org/</LinkExternal>) und zusätzlich die US-amerikanische Webseite (<LinkExternal href="http://www.aboutads.info/choices">http://www.aboutads.info/choices</LinkExternal>) oder die europäische Webseite (<LinkExternal href="http://www.youronlinechoices.com/uk/your-ad-choices">http://www.youronlinechoices.com/uk/your-ad-choices</LinkExternal>) widersprechen.</p>
    <h2>Verwendung von Matomo (ehemals Piwik)</h2>
    <p>Diese Webseite benutzt Matomo, eine Open-Source-Software zur statistischen Auswertung von Besucherzugriffen. Matomo verwendet sog. „Cookies“, Textdateien, die auf Ihrem Computer gespeichert werden und die eine Analyse der Benutzung der Website durch Sie ermöglichen.</p>
    <p>Die durch den Cookie erzeugten Informationen über Ihre Nutzung des Internetangebotes werden auf einem Server in Deutschland gespeichert.</p>
    ...
    <h2>Der Landesbeauftragte für den Datenschutz und die Informationsfreiheit</h2>
    <p>
      Königstr. 10a
      <br />70173 Stuttgart
